<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Usuario.aspx.cs" Inherits="Agenda.Usuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSourceUsuarios" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
        DeleteCommand="DELETE FROM [Usuarios] WHERE [Email] = @Email"
        InsertCommand="INSERT INTO [Usuarios] ([Email], [Nome], [Senha]) VALUES (@Email, @Nome, @Senha)"
        SelectCommand="SELECT * FROM [Usuarios]"
        UpdateCommand="UPDATE [Usuarios] SET [Nome] = @Nome, [Senha] = @Senha WHERE [Email] = @Email">
        <DeleteParameters>
